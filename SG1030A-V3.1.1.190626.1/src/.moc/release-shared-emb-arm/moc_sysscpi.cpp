...
static const char qt_meta_stringdata_tSysScpi[] = {
    ...
    "drawPluseModulate()\0drawSystemPara()\0"
    "drawArbitraryWave()\0drawFreqInParamter()\0"
    "drawAmplInParamter()\0drawExfFref()\0"
    "drawDrgFunction()\0type\0drawSweep(int)\0"
    "drawFreqAndAmplMain()\0drawState()\0"
    "drawInputParamterNoParamter()\0str,funcode\0"
    "drawInputParamter(char*,int)\0drawButton()\0"
...
void tSysScpi::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 10: _t->drawPluseModulate(); break;
        ...
        case 17: _t->drawSweep((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 18: _t->drawFreqAndAmplMain(); break;
        case 19: _t->drawState(); break;
        case 20: _t->drawInputParamterNoParamter(); break;
        case 21: _t->drawInputParamter((*reinterpret_cast< char*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
...
// SIGNAL 10
void tSysScpi::drawPluseModulate()
{
...
// SIGNAL 18
void tSysScpi::drawFreqAndAmplMain()
{
...
// SIGNAL 20
void tSysScpi::drawInputParamterNoParamter()
{
    QMetaObject::activate(this, &staticMetaObject, 20, 0);
}

// SIGNAL 21
void tSysScpi::drawInputParamter(char * _t1, int _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
