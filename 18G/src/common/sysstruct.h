...
static unsigned long RAMCIC_HZ[] = {5e6, 3e6, 2e6, 1e6, 500e3, 300e3, 200e3, 100e3, 50e3, 30e3, 20e3, 10e3, 5e3, 3e3,  2e3, 1e3, 500, 300, 200, 100, 50, 30, 20, 10};
...
static struct fftDataDef fftBandList[] =
{
	//rbw            cic             fft             length	     fstep     RBW送数
	  {10,     1250,     8192,		6400,		32e3},  //  7
	  {20,     625,      8192,  	6400, 		64e3},  //  6
	  {30,     500,      8192,      6400,		80e3},  //  5
	  {50,     250,      8192,      6400,		160e3}, //  4
	  {100,    250,      4096,      3200,		160e3}, //  3
	  {200,    125,      4096,      3200,		320e3}, //  2
	  {300,    100,      4096,      3200,		400e3}, //  1
	  {500,    50,       4096,      3200,		800e3}, //  0
//  {10,     625,     16384,	12800,		64e3},
//  {20,     320,     16384,  12800, 		125e3},
//  {30,     210,     16384,  12800,		192e3},
//  {50,     125,     16384,  12800,		320e3},
//  {100,    125,     8192,   6400,			320e3},
//  {200,    64,      8192,   6400,			625e3},
//  {300,    50,      8192,   6400,			0.8e6},
//  {500,    25,  		8192,   6400,			1.6e6},
};
