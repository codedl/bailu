...
#define SOCKETSERVERIP_ZC	  "192.168.1.138"   //直采校准服务器IP地址
#define SOCKETSEVERPORT_ZC    5025               //直采校准服务器端口  优利德:4162
...
static unsigned long long FREQRESPHZ[] = {
							...
							7e9, 7.05e9, 7.1e9, 7.15e9, 7.2e9, 7.25e9, 7.3e9, 7.35e9, 7.4e9, 7.45e9, 7.49e9,7.5e9, 7.51e9, 7.49e9,7.5e9, 7.51e9,7.55e9,7.6e9, 7.65e9, 7.7e9, 7.75e9, 7.8e9, 7.85e9, 7.9e9, 7.95e9, 8e9, //140~161
							8.05e9, 8.1e9, 8.15e9, 8.2e9, 8.25e9, 8.3e9, 8.35e9, 8.4e9, 8.45e9, 8.5e9, 8.55e9, 8.6e9, 8.65e9, 8.7e9, 8.75e9, 8.8e9, 8.85e9, 8.9e9, 8.95e9, //162~182
							...
							10e9, 10.05e9, 10.1e9, 10.15e9, 10.2e9, 10.25e9, 10.3e9, 10.35e9, 10.4e9, 10.45e9, 10.5e9, 10.55e9, //203~214
							10.6e9, 10.65e9, 10.7e9, 10.75e9, 10.8e9, 10.85e9, 10.9e9, 10.95e9,10.99e9,//215~225
							11e9, 11.01e9,  10.99e9, 11e9, 11.01e9, 11.05e9, 11.1e9,11.15e9, 11.2e9, 11.25e9, 11.3e9, 11.35e9, 11.4e9, 11.45e9, 11.5e9, 11.55e9, 11.6e9, 11.65e9, 11.7e9, 11.75e9, 11.8e9, 11.85e9, 11.9e9, 11.95e9, //226~245
							12e9, 12.05e9, 12.1e9, 12.15e9, 12.2e9, 12.25e9, 12.3e9, 12.35e9, 12.4e9, 12.45e9, 12.5e9, 12.55e9, 12.6e9, 12.65e9, 12.7e9, 12.75e9, 12.8e9, 12.85e9, 12.9e9, 12.95e9, 13e9, //246~267
							13.05e9, 13.1e9, 13.15e9, 13.2e9, 13.25e9, 13.3e9, 13.35e9, 13.4e9, 13.45e9, 13.5e9, 13.55e9, 13.59e9, 13.6e9, 13.61e9, 13.59e9,13.6e9,13.61e9,13.65e9,13.7e9, 13.75e9, 13.8e9, 13.85e9, 13.9e9, 13.95e9,//268~288
							...
							15e9, 15.05e9, 15.1e9, 15.15e9, 15.2e9, 15.25e9, 15.3e9, 15.35e9, 15.4e9, 15.45e9, 15.5e9,  //309~320
							15.55e9, 15.6e9, 15.65e9, 15.7e9, 15.75e9, 15.8e9, 15.85e9, 15.9e9, 15.95e9, //321~331
							15.99e9,16e9,16.01e9, 15.99e9,16e9,16.01e9,16.05e9,16.1e9, 16.15e9, 16.2e9, 16.25e9, 16.3e9, 16.35e9, 16.4e9, 16.45e9, 16.5e9, 16.55e9, 16.6e9, 16.65e9, 16.7e9, 16.75e9, 16.8e9, 16.85e9, 16.9e9, 16.95e9,//332~351
...
#define FREQRESPCOUNT   (sizeof(FREQRESPHZ) / sizeof(FREQRESPHZ[0]))
...
struct rfDataDef
{
  ...
  unsigned char Start_Band;//起始波段
  unsigned char Stop_Band;//停止波段
  ...
  int N_H;			  		
  int N_HL;           		           //混频低波段时步进次数
  unsigned int N_HL_START_INT;		  //混频低波段起始频率的整数分频值
  unsigned int N_HL_START_FRAC;      //混频低波段起始频率的小数分频值
  unsigned int N_HL_STOP_INT;       //混频低波段起始频率的小数分频值
  unsigned int N_HL_STOP_FRAC;     //混频低波段终止频率的整数分频值
  int N_HH;           		      //混频高波段L时步进次数
  unsigned int N_HH_START_INT;   //混频高波段起始频率的整数分频值
  unsigned int N_HH_START_FRAC; //混频高波段起始频率的小数分频值
  unsigned int N_HH_STOP_INT;  //混频高波段L终止频率的整数分频值
  unsigned int N_HH_STOP_FRAC;//混频高波段L终止频率的小数分频值
  unsigned int N_QSTEP;      //混频段本振步进的量化值
  unsigned int N_HH1_START_INT;
  unsigned int N_HH1_START_FRAC;
  unsigned int N_HH4_START_INT;   //混频高波段H起始频率的整数分频值
  unsigned int N_HH4_START_FRAC; //混频高波段H起始频率的小数分频值
  unsigned int N_HH4_STOP_INT;  //混频高波段H终止频率的整数分频值
  unsigned int N_HH4_STOP_FRAC;//混频高波段H终止频率的小数分频值
  unsigned int N_HH2_STOP_INT;
  unsigned int N_HH2_STOP_FRAC;
  int N_HH1;			   //混频高波段L第一分段步进次数
  int N_HH2;			  //混频高波段L第二分段步进次数
  int N_HH3;			 //混频高波段L第三分段步进次数
  int N_HH4;			//混频高波段L第四分段步进次数
...
struct amptDef
{
  ...
  double refLevelMax;//20,0 if pre on
  double refLevel;
  double LMPValue;
