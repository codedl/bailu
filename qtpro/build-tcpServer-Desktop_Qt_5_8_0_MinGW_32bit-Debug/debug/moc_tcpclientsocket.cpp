...
QT_MOC_LITERAL(4, 37, 7), // "datarcv"
QT_MOC_LITERAL(5, 45, 16) // "slotdisconnected"

    },
    "TcpClientSocket\0update\0\0disconnected\0"
    "datarcv\0slotdisconnected"
};
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->update((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->disconnected((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->datarcv(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpClientSocket::update)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpClientSocket::update(QString _t1, int _t2)
{
