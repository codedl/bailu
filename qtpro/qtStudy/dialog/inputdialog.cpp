...
{
    bool ok;
    QString text=QInputDialog::getText(this,tr("字符串输入"),
...
void InputDlg::ChangeSex()
{
    ...
    SexItems << tr("男") << tr("女");
    bool ok;
    QString SexItem = QInputDialog::getItem(this, tr("条目选择"),
...
{
    bool ok;
    int age = QInputDialog::getInt(this, tr("int类型输入"),
...
{
    bool ok;
    double score = QInputDialog::getDouble(this, tr("double类型输入"),
