...
//    bool keyBoardSwitchMod,keyBoardSwitchLF,keyBoardSwitchRF;
	...
	int sendSerialDataToFrontPanel(QString cmd);							//发送数据到前面板
	...
	void keyBoardLEDSwitch(char LED, bool state);                          //控制键盘灯
	...
	int setFreqIncr(double value);									//设置频率增量
	int setAmplIncr(double value);
...
//	int setSweepstate(int value);
	...
	int setAMSource(bool value);
	int setAMSource(QString value);
	int setAMInternalWave(int value);//AM内部函数波形
	int setAMInternalWave(QString value);
	...
	int setAmCoupling(bool value);
	int setAmCoupling(QString value);
    
	//FMPM
	int setFMPMMode(int value);
	int setFMPMMode(QString value);
	//FM
	...
	int setFMSource(bool value);
	int setFMSource(QString value);
    int setFmRate(double value);                                //设置
    int setFmRate(QString value);                               //设置
    int setFmRateWithRpg(int value);                            //脉冲旋钮设置
	int setFMInternalWave(int value);
	int setFMInternalWave(QString value);
	int setFMCoupling(bool value);
	int setFMCoupling(QString value);
	...
	int setPMSource(bool value);
	int setPMSource(QString value);
	int setPMInternalWave(int value);
	int setPMInternalWave(QString value);
	int setPmRate(double value);                                //设置
    int setPmRate(QString value);                               //设置
    int setPmRateWithRpg(int value);                            //脉冲旋钮设置
	int setPMCoupling(bool value);
	int setPMCoupling(QString value);
	...
	//USB功率计
	bool usbUSBPowerInit(void);
	bool connectToUSBPower(void);
	void disconectFromUSBPower(void);
	bool getAmptStrFromUSBPower(void);
	bool usbUSBPowerSend(unsigned char* data, int len);
	bool usbUSBPowerRecv(unsigned char* data, int dataLen, int* recvLen);
	int setUSPPowerState(bool value);
	int setUSPPowerState(QString value);
	int setUSBPowerFreq(double value);
	int setUSBPowerFreq(QString value);
	int setUSBPowerFreqWithRpg(int value);
	int setUSBPowerAmplOffset(double value);
	int setUSBPowerAmplOffset(QString value);
	int setUSBPowerAmplOffsetWithRpg(int value);
	int setUSBPowerAdvMode(int value);
	int setUSBPowerAdvMode(QString value);
	int setUSBPowerAdvCount(double value);
	int setUSBPowerAdvCount(QString value);
	int setUSBPowerAdvCountWithRpg(int value);
	int setUSBPowerMeasUnit(int value);
	int setUSBPowerMeasUnit(QString value);
#if 0
    //ASK
...
#endif
    //Pulse
    int setPulseState(int value);
    int setPulseState(QString value);
    int setPulseSource(int value);
    int setPulseSource(QString value);
	int setPulseMethod(int value);
	int setPulseMethod(QString value);
    int setPulsePeriod(double value);
    int setPulsePeriod(QString value);
    int setPulsePeriodWithRpg(int value);
    int setPulseWidth(double value);                                //设置
    int setPulseWidth(QString value);                               //设置
    int setPulseWidthWithRpg(int value);                            //脉冲旋钮设置
	int setPulseDelay(double value);
	int setPulseDelay(QString value);
	int setPulseDelayWithRpg(int value);
	int setPulseExtPolarity(int value);
	int setPulseExtPolarity(QString value);
...
//    void checkMultiDisplay(multiDispType value);
  ...
  signals:
	...
	virtual void drawPulseModulate(void);                                    //绘制脉冲调制
...
//    virtual void drawFreqAndAmpl(void);                                       //绘制频率幅度
	...
	virtual void drawUSBPower();											  //绘制USB功率计
    virtual void drawSweep(int type);                                         //绘制扫描

    virtual void drawMainPara(void);		                              //绘制主参数显示区
    virtual void drawState(void);	   	                                  //绘制背景
    virtual void drawInputParamter(void);	                              //绘制输入栏显示区
