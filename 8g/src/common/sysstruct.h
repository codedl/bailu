...
#define MINFREQ         1e3                 //最小频率
//#define MAXFREQ         (8e9 + MINFREQ)      //最大频率
#define MAXFREQ         8e9      		//最大频率
...
#define FREQ_START_HH_BAND1     3.3e9
#define FREQ_START_HH_BAND2		4.4e9
#define FREQ_START_HH_BAND3		5.5e9
#define FREQ_START_HH_BAND4		6.6e9
...
struct freqDef
{
  ...
  bool cfStepAuto;
  double offset;
  bool refInternal;//inside if  true 
  bool typeLine;
  bool isShowCenter;
  bool lineZero;
...
struct spanDef
{
  double prvSpan;
  double nowSpan;
  double span;//stop fre - start fre
